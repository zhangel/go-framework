...
func (c *Config) Walk(path string, visitor func(path string, val Value) bool) {
	if c.root.Type() != ObjectType {
		return
	}

	if path == "" {
		c.root.(Object).Walk("", visitor)
	} else if v := c.root.(Object).find(path); v != nil {
		v.Walk(path, visitor)
	}
}
...
type Value interface {
	...
	String() string
	isConcatenable() bool
	Walk(parent string, visitor func(path string, val Value) bool) bool
}
...
func (s String) Walk(parent string, visitor func(path string, val Value) bool) bool {
	return visitor(parent, s)
}
...
func (o Object) Walk(parent string, visitor func(path string, val Value) bool) bool {
	for k, v := range o {
		var path string
		if parent == "" {
			path = k
...
func (a Array) Walk(parent string, visitor func(path string, val Value) bool) bool {
	var result []string
	...
	for _, v := range a {
		...
		case NumberType:
			result = append(result, internal.Stringify(v))
		}
	}

	visitor(parent, String(strings.Join(result, ",")))
	return true
}
...
func (i Int) Walk(parent string, visitor func(path string, val Value) bool) bool {
	return visitor(parent, i)
}
...
func (f Float32) Walk(parent string, visitor func(path string, val Value) bool) bool {
	return visitor(parent, f)
}
...
func (f Float64) Walk(parent string, visitor func(path string, val Value) bool) bool {
	return visitor(parent, f)
}
...
func (b Boolean) Walk(parent string, visitor func(path string, val Value) bool) bool {
	return visitor(parent, b)
}
...
func (s *Substitution) Walk(parent string, visitor func(path string, val Value) bool) bool {
	return true
}
...
func (n Null) Walk(parent string, visitor func(path string, val Value) bool) bool {
	return true
}
...
func (d Duration) Walk(parent string, visitor func(path string, val Value) bool) bool {
	return visitor(parent, d)
}
...
func (c concatenation) Walk(parent string, visitor func(path string, val Value) bool) bool {
	return true
}
